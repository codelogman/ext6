...
public class Filemerge {
     ...
     * @throws java.io.IOException  if an IO error occurs during copying
     */
    public static void copyFile(File srcFile, java.io.File destFile) throws IOException {
     ...
     * @throws java.io.IOException  if an IO error occurs during copying
     */
    public static void copyFile(File srcFile, java.io.File destFile,
        ...
        java.io.File parentFile = destFile.getParentFile();
        if (parentFile != null) {
     ...
     */
    private static void doCopyFile(File srcFile, java.io.File destFile, boolean preserveFileDate) throws IOException {
    ...
    private static void exportToDisk (info.guardianproject.iocipher.File fileIn, java.io.File fileout) throws IOException
    {
     ...
     * @since 1.1
     */
    public static void copyDirectory(File srcDir, java.io.File destDir) throws IOException {
     ...
     * @since 1.1
     */
    public static void copyDirectory(File srcDir, java.io.File destDir,
                                     boolean preserveFileDate) throws IOException {
    ...
    public static void copyDirectory(File srcDir, java.io.File destDir,
        ...
        if (destDir.getCanonicalPath().startsWith(srcDir.getCanonicalPath())) {
            File[] srcFiles = filter == null ? srcDir.listFiles() : (File[]) srcDir.listFiles(filter);
            if (srcFiles != null && srcFiles.length > 0) {
                exclusionList = new ArrayList<String>(srcFiles.length);
                for (File srcFile : srcFiles) {
                    java.io.File copiedFile = new java.io.File(destDir, srcFile.getName());
     ...
     * @since 1.1
     */
    private static void doCopyDirectory(File srcDir, java.io.File destDir, FileFilter filter,
        ...
        for (File srcFile : srcFiles) {
            java.io.File dstFile = new java.io.File(destDir, srcFile.getName());
            if (exclusionList == null || !exclusionList.contains(srcFile.getCanonicalPath())) {
                if (srcFile.isDirectory()) {
                    doCopyDirectory(srcFile, dstFile, filter, preserveFileDate, exclusionList);
                } else {
                    exportToDisk(srcFile,dstFile);
                }
            }
        }
