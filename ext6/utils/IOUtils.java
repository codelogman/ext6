...
import tar.eof.ext6.utils.stream.*;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return tar.eof.ext6.utils.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        tar.eof.ext6.utils.stream.ByteArrayOutputStream output = new tar.eof.ext6.utils.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * before using {@link tar.eof.ext6.utils.IOUtils#toByteArray(java.io.InputStream, int)} to read into the byte array.
     ...
     * @see tar.eof.ext6.utils.IOUtils#toByteArray(java.io.InputStream, int)
     * @since 2.1
     */
