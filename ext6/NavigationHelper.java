...
import tar.eof.ext6.fileoperations.FileNavigator;
...
import tar.eof.ext6.utils.LastModifiedFileComparator;
import tar.eof.ext6.utils.NameFileComparator;
import tar.eof.ext6.utils.SizeFileComparator;
...
public class NavigationHelper {
    ...
    public ArrayList<FileItem> getFilesItemsInCurrentDirectory() {
        ...
        if (files != null) {
            mFiles.clear();
            Comparator<java.io.File> comparator = NameFileComparator.NAME_INSENSITIVE_COMPARATOR;
            switch(option) {
                case SIZE:
